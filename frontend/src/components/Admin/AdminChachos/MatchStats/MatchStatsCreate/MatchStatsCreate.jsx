...
const MatchStatsCreate = () => {
  ...
  return (
    <>
      <AdminMenu />
      <div className="container create-match-stat-container">
        <div className="create-match-stat-title">
        ...
        <div className="create-match-stat-details">
        ...
        <form className="create-match-stat-form" onSubmit={formik.handleSubmit}>
          ...
          {tournamentRound?.players?.map((player) => (
            <div key={player._id} className="create-match-stat-form-player">
              <label>
                {player.first_name} {player.last_name}
              </label>

              <div className="create-match-stat-form-player-inputs">
                {/* Minutos jugados */}
                <div>
                  <p>Minutos:</p>
                  <input
          ...
          <button type="submit">Crear estadísticas</button>
        </form>
      </div>
    </>
  );
