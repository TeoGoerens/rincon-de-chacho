              ...
              <>
                ...
                <div className="ce-alter-grid">
                  {[
                    ...
                    {
                      num: "04", title: "% de votos respecto de PJ",
                      left:  { label: "Votante más activo",  items: voteRecords.mostActiveList  ?? [], getValue: (r) => `${r.pct}%`,                                                                                           getName: (r) => `${r.player.first_name} ${r.player.last_name}`, getCtx: ()  => "de fechas votadas",                                                                                                         getPic: (r) => r.profile_picture },
                      right: { label: "Votante menos activo", items: voteRecords.leastActiveList ?? [], getValue: (r) => `${r.pct}%`,                                                                                          getName: (r) => `${r.player.first_name} ${r.player.last_name}`, getCtx: ()  => "de fechas votadas",                                                                                                         getPic: (r) => r.profile_picture },
                    },
                    {
